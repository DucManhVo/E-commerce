        ...
        <div class="container text-center text-md-start mt-5">
          <div class="row mt-3">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p>
                <FontAwesomeIcon icon={faLocationDot} /> 8C Nguyễn Gia Trí P25
                Bình Thạnh TPHCM
              </p>
              <a
                className="text-decoration-none text-white"
                href="mailto:voducmanh000@gmail.com"
              >
                <FontAwesomeIcon icon={faEnvelope} /> voducmanh000@gmail.com
              </a>
              <br />
              <a
                className="text-decoration-none text-white"
                href="tel:voducmanh000@gmail.com"
              >
                <FontAwesomeIcon icon={faPhone} /> 0981033175
              </a>
            </div>
          </div>
        </div>
